...
gulp.task("copyfile",function(){
	gulp.src("*.html")
	.pipe(gulp.dest("D:\\phpStudy\\WWW\\MEIZU"));
});
// 复制JS文件
gulp.task("copyjs",function(){
	gulp.src("js/*.js")
	.pipe(gulp.dest("D:\\phpStudy\\WWW\\MEIZU\\js"));
});
// 复制css文件
gulp.task("copycss",function(){
	gulp.src("css/*.css")
	.pipe(gulp.dest("D:\\phpStudy\\WWW\\MEIZU\\css"));
});
// 复制图片文件
gulp.task("images",function(){
	gulp.src("images/*.*")
	.pipe(gulp.dest("D:\\phpStudy\\WWW\\MEIZU\\img"));
});
